...
#define D_IOUART9d_TX_PORT	GPIOD
#define D_IOUART9d_TX_PIN	GPIO_PIN_2

#define D_IOUART9d_HIGH		D_IO_HIGH(D_IOUART9d_TX_PORT, D_IOUART9d_TX_PIN)
#define D_IOUART9d_LOW		D_IO_LOW(D_IOUART9d_TX_PORT, D_IOUART9d_TX_PIN)

#define D_IOUART9d_READ_PORT	GPIOD
#define D_IOUART9d_READ_PIN	GPIO_PIN_0

#define D_IOUART3d_RX_PORT	GPIOC
#define D_IOUART3d_RX_PIN	GPIO_PIN_2
#define D_IOUART3d_TX_PORT	GPIOC
#define D_IOUART3d_TX_PIN	GPIO_PIN_1
#endif
