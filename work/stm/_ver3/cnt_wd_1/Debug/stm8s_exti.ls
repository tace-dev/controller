 ...
 433                     ; 126     assert_param(IS_EXTI_PORT_OK(Port));
 435                     ; 128     switch (Port)
 438                     ; 145     default:
 438                     ; 146         break;
 439  0003 4d            	tnz	a
 ...
 468  0024               L741:
 469                     ; 136     case EXTI_PORT_GPIOC:
 469                     ; 137         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PCIS) >> 4);
 471  0024 c650a0        	ld	a,20640
 472  0027 4e            	swap	a
 473                     ; 138         break;
 475  0028 200d          	jp	LC005
 476  002a               L151:
 477                     ; 139     case EXTI_PORT_GPIOD:
 477                     ; 140         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PDIS) >> 6);
 ...
 496                     ; 145     default:
 496                     ; 146         break;
 498                     ; 149     return((EXTI_Sensitivity_TypeDef)value);
 502  0039 5b01          	addw	sp,#1
 503  003b 81            	ret	
 537                     ; 157 EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
 537                     ; 158 {
 538                     .text:	section	.text,new
 539  0000               _EXTI_GetTLISensitivity:
 541  0000 88            	push	a
 542       00000001      OFST:	set	1
 545                     ; 160     uint8_t value = 0;
 547                     ; 163     value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
 549  0001 c650a1        	ld	a,20641
 550  0004 a404          	and	a,#4
 551                     ; 165     return((EXTI_TLISensitivity_TypeDef)value);
 555  0006 5b01          	addw	sp,#1
 556  0008 81            	ret	
