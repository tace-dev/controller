 ...
 327  001c 54            	srlw	x
 328  001d 54            	srlw	x
 329  001e 1f05          	ldw	(OFST-1,sp),x
 330                     ; 131     if ((8U * A) >= ((lsifreqkhz - (8U * A)) * (1U + (2U * A))))
 332  0020 58            	sllw	x
 333  0021 58            	sllw	x
 334  0022 58            	sllw	x
 335  0023 1f01          	ldw	(OFST-5,sp),x
 336  0025 1e03          	ldw	x,(OFST-3,sp)
 337  0027 72f001        	subw	x,(OFST-5,sp)
 338  002a 1605          	ldw	y,(OFST-1,sp)
 339  002c 9058          	sllw	y
 340  002e 905c          	incw	y
 341  0030 cd0000        	call	c_imul
 343  0033 1605          	ldw	y,(OFST-1,sp)
 344  0035 9058          	sllw	y
 345  0037 9058          	sllw	y
 346  0039 bf00          	ldw	c_x,x
 347  003b 9058          	sllw	y
 348  003d 90b300        	cpw	y,c_x
 349  0040 7b06          	ld	a,(OFST+0,sp)
 350  0042 2504          	jrult	L521
 351                     ; 133         BEEP->CSR |= (uint8_t)(A - 2U);
 353  0044 a002          	sub	a,#2
 355  0046 2001          	jra	L721
 356  0048               L521:
 357                     ; 137         BEEP->CSR |= (uint8_t)(A - 1U);
 359  0048 4a            	dec	a
 360  0049               L721:
 361  0049 ca50f3        	or	a,20723
 362  004c c750f3        	ld	20723,a
 363                     ; 139 }
 366  004f 5b06          	addw	sp,#6
 367  0051 81            	ret	
