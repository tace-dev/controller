 ...
 973  035a 27            	dc.b	39
 974  035b 3a            	dc.b	58
1014                     ; 318 LCD_DISP_FUNC_1(lcd_disp_plc, 12, _plc)
...
1055  002a 85            	popw	x
1056  002b 81            	ret	
1098                     ; 320 LCD_DISP_FUNC_1(lcd_disp_cnt_host, 9, _cnt_host)
...
1139  002a 85            	popw	x
1140  002b 81            	ret	
1182                     ; 321 LCD_DISP_FUNC_1(lcd_disp_cnt_sub, 8, _cnt_sub)
...
1223  002a 85            	popw	x
1224  002b 81            	ret	
1266                     ; 323 LCD_DISP_FUNC_1(lcd_disp_mir1, 7, _mir1)
...
1307  002a 85            	popw	x
1308  002b 81            	ret	
1350                     ; 324 LCD_DISP_FUNC_1(lcd_disp_mir2, 10, _mir2)
...
1391  002a 85            	popw	x
1392  002b 81            	ret	
1434                     ; 325 LCD_DISP_FUNC_1(lcd_disp_freset, 6, _freset)
...
1475  002a 85            	popw	x
1476  002b 81            	ret	
1519                     ; 327 LCD_DISP_FUNC(lcd_disp_backlight, 8, _bL)
...
1565  002d 85            	popw	x
1566  002e 81            	ret	
1609                     ; 329 LCD_DISP_FUNC(lcd_disp_setup_lpm, 8, _lpm)
...
1655  002d 85            	popw	x
1656  002e 81            	ret	
1700                     ; 330 LCD_DISP_FUNC(lcd_disp_setup_temp_offset, 4, _temp_offset)
...
1746  002d 85            	popw	x
1747  002e 81            	ret	
1791                     ; 332 LCD_DISP_FUNC(lcd_disp_setup_po_type, 9, _po_type)
...
1837  002d 85            	popw	x
1838  002e 81            	ret	
1881                     ; 333 LCD_DISP_FUNC_1(lcd_disp_setup_po_type_xl, 8, _po_type_xl)
...
1922  002a 85            	popw	x
1923  002b 81            	ret	
1966                     ; 334 LCD_DISP_FUNC_1(lcd_disp_setup_po_type_pb, 10, _po_type_pb)
...
2007  002a 85            	popw	x
2008  002b 81            	ret	
2051                     ; 338 LCD_DISP_FUNC(lcd_disp_setup_len, 3, _len)
...
2097  002d 85            	popw	x
2098  002e 81            	ret	
2142                     ; 339 LCD_DISP_FUNC(lcd_disp_setup_cntl_op, 9, _cntl_op)
...
2188  002d 85            	popw	x
2189  002e 81            	ret	
2232                     ; 340 LCD_DISP_FUNC_1(lcd_disp_setup_cntl_on, 8, _cntl_on)
...
2273  002a 85            	popw	x
2274  002b 81            	ret	
2317                     ; 341 LCD_DISP_FUNC_1(lcd_disp_setup_cntl_po, 9, _cntl_po)
...
2358  002a 85            	popw	x
2359  002b 81            	ret	
2402                     ; 342 LCD_DISP_FUNC_1(lcd_disp_setup_cntl_2motor, 10, _cntl_2motor)
...
2443  002a 85            	popw	x
2444  002b 81            	ret	
2487                     ; 343 LCD_DISP_FUNC_1(lcd_disp_setup_cntl_tab, 8, _cntl_tab)
...
2528  002a 85            	popw	x
2529  002b 81            	ret	
2572                     ; 345 LCD_DISP_FUNC(lcd_disp_setup_c, 1, _cc)
...
2616  002a 85            	popw	x
2617  002b 81            	ret	
2661                     ; 347 LCD_DISP_FUNC(lcd_disp_setup_link, 6, _link)
...
2707  002d 85            	popw	x
2708  002e 81            	ret	
2751                     ; 349 LCD_DISP_FUNC(lcd_disp_setup_run, 8, _run)
...
2797  002d 85            	popw	x
2798  002e 81            	ret	
2841                     ; 351 LCD_DISP_FUNC_1(lcd_disp_setup_mode_local, 7, _hcLocal)
...
2882  002a 85            	popw	x
2883  002b 81            	ret	
2926                     ; 352 LCD_DISP_FUNC_1(lcd_disp_setup_mode_each, 11, _hcEach)
...
2967  002a 85            	popw	x
2968  002b 81            	ret	
3012                     ; 353 LCD_DISP_FUNC(lcd_disp_setup_mode, 8, _hc)
...
3058  002d 85            	popw	x
3059  002e 81            	ret	
3102                     ; 355 LCD_DISP_FUNC(lcd_disp_setup_id, 6, _nid)
...
3148  002d 85            	popw	x
3149  002e 81            	ret	
3192                     ; 356 LCD_DISP_FUNC(lcd_disp_setup_m, 3, _nm)
...
3238  002d 85            	popw	x
3239  002e 81            	ret	
3282                     ; 357 LCD_DISP_FUNC(lcd_disp_setup_cnt, 6, _ncnt)
...
3328  002d 85            	popw	x
3329  002e 81            	ret	
3373                     ; 358 LCD_DISP_FUNC(lcd_disp_setup_valve, 6, _nvalve)
...
3419  002d 85            	popw	x
3420  002e 81            	ret	
3463                     ; 360 LCD_CLEAR_FUNC(lcd_clear_backlight, 8, _bL)
...
3505  002b 85            	popw	x
3506  002c 81            	ret	
3548                     ; 361 LCD_CLEAR_FUNC(lcd_clear_c, 4, _cc)
...
3590  002b 85            	popw	x
3591  002c 81            	ret	
3633                     ; 363 LCD_CLEAR_FUNC(lcd_clear_btn, 5, _btn)
...
3675  002b 85            	popw	x
3676  002c 81            	ret	
3718                     ; 364 LCD_CLEAR_FUNC(lcd_clear_run, 8, _run)
...
3760  002b 85            	popw	x
3761  002c 81            	ret	
3803                     ; 365 LCD_CLEAR_FUNC(lcd_clear_mode, 8, _hc)
...
3845  002b 85            	popw	x
3846  002c 81            	ret	
3888                     ; 367 LCD_CLEAR_FUNC(lcd_clear_info, 3, _info)
...
3930  002b 85            	popw	x
3931  002c 81            	ret	
3973                     ; 372 LCD_CLEAR_FUNC(lcd_clear_rid, 12, _rid)
...
4015  002b 85            	popw	x
4016  002c 81            	ret	
4058                     ; 373 LCD_CLEAR_FUNC(lcd_clear_n, 42, _n)
...
4100  002b 85            	popw	x
4101  002c 81            	ret	
4143                     ; 378 LCD_CLEAR_FUNC(lcd_clear_m, 3, _nm)
...
4185  002b 85            	popw	x
4186  002c 81            	ret	
4228                     ; 379 LCD_CLEAR_FUNC(lcd_clear_cnt, 6, _ncnt)
...
4270  002b 85            	popw	x
4271  002c 81            	ret	
4320                     ; 381 void	lcd_clear_npos(uint8_t pos, uint8_t type)
4320                     ; 382 {
...
4505  0012 84            	pop	a
4506  0013 81            	ret	
4555                     ; 406 uint8_t	*lcd_get_npos(uint8_t i)
4555                     ; 407 {
...
4779  005b 81            	ret	
4836                     ; 448 void	lcd_disp_err(uint8_t n)
4836                     ; 449 {
...
4848                     ; 453 	lcd_clear_n();
4850  0007 cd0000        	call	_lcd_clear_n
4852                     ; 454 	p = error_type==1 ? _nerrBr : _nerr;
...
4863                     ; 455 	for( i=0; i<7; i++ )
4865  001a 0f04          	clr	(OFST+0,sp)
4866  001c               L3361:
4867                     ; 457 		LCD_BIT_SET(p[i]);
...
4918  005e               L7061:
4919                     ; 461 Print:		
4919                     ; 462 //		LCD_BIT_SET(bCOL);
4919                     ; 463 		lcd_disp_n(2, n/10);
...
5025                     ; 473 void	lcd_disp_rid(uint8_t id, uint8_t mode, uint8_t multi)
5025                     ; 474 {
...
5034                     ; 477 	uint8_t	_b[] = { bT8, bT11, bT15, bT19, bT23, bT26, g10, g10 };
...
5049                     ; 483 		for( j=0; j<6; j++ )
5051  0016 6b09          	ld	(OFST+0,sp),a
5052  0018               L1071:
5053                     ; 484 			LCD_BIT_CLEAR(_b[j]);
...
5198  00ca 81            	ret	
5247                     ; 520 void	lcd_clear_rid_n(uint8_t id, uint8_t mode)
5247                     ; 521 {
...
5319  004c 81            	ret	
5360                     ; 536 void	lcd_disp_cmd(uint8_t cmd, uint8_t mode, uint8_t multi)
5360                     ; 537 {
...
5388  001e 84            	pop	a
5389  001f 81            	ret	
5424                     ; 552 void	lcd_disp_info_fire(uint8_t mode)
5424                     ; 553 {
...
5599                     ; 577 		lcd_clear_info();
5601  000a cd0000        	call	_lcd_clear_info
5603  000d               L5402:
5604                     ; 582 	j = _info[info];
...
5656  0000               ___i:
5657  0000 00            	dc.b	0
5697                     ; 601 void	lcd_disp(uint8_t id, uint8_t enable)
5697                     ; 602 {
...
5741                     ; 613 		lcd_disp_n(3, __i);
5742  002d 2009          	jra	L3702
5743  002f               L1702:
5744                     ; 617 		LCD->RAM[LCD_RAMRegister_1] &= (uint8_t)(~id);
...
5760                     ; 611 		lcd_disp_n(1, __i);
5762  003e c60000        	ld	a,___i
5763  0041 97            	ld	xl,a
5764  0042 81            	ret	
5796                     ; 621 void	lcd_init(void)
5796                     ; 622 {
...
5829  0017 84            	pop	a
5830  0018 81            	ret	
5862                     ; 631 void	lcd_cntl(uint8_t cmd, uint8_t param)
5862                     ; 632 {
5863                     .text:	section	.text,new
5864  0000               _lcd_cntl:
5868                     ; 651 }
5871  0000 81            	ret	
5894                     ; 653 void	systemLcdClear(void)
5894                     ; 654 {
5895                     .text:	section	.text,new
5896  0000               _systemLcdClear:
5900                     ; 655 	LCD->CR1 = LCD_CR1_RESET_VALUE;
5902  0000 725f5400      	clr	21504
5903                     ; 656 	LCD->CR2 = LCD_CR2_RESET_VALUE;
5905  0004 725f5401      	clr	21505
5906                     ; 657 	LCD->CR3 = LCD_CR3_RESET_VALUE;
5908  0008 725f5402      	clr	21506
5909                     ; 658 	LCD->FRQ = LCD_FRQ_RESET_VALUE;
5911  000c 725f5403      	clr	21507
5912                     ; 660 	LCD->CR4 = LCD_CR4_RESET_VALUE;
5914  0010 725f542f      	clr	21551
5915                     ; 661 }
5918  0014 81            	ret	
5952                     ; 698 void	systemLcd(void)
5952                     ; 699 {
5953                     .text:	section	.text,new
5954  0000               _systemLcd:
5958                     ; 700 	CLK_PeripheralClockConfig(CLK_Peripheral_LCD, ENABLE);
5960  0000 ae1301        	ldw	x,#4865
5961  0003 cd0000        	call	_CLK_PeripheralClockConfig
5963                     ; 701 	CLK_RTCClockConfig(CLK_RTCCLKSource_LSI, CLK_RTCCLKDiv_1);
5965  0006 ae0400        	ldw	x,#1024
5966  0009 cd0000        	call	_CLK_RTCClockConfig
5968                     ; 702 	CLK_PeripheralClockConfig(CLK_Peripheral_RTC, ENABLE);
5970  000c ae1201        	ldw	x,#4609
5971  000f cd0000        	call	_CLK_PeripheralClockConfig
5973                     ; 704 	systemLcdClear();
5975  0012 cd0000        	call	_systemLcdClear
5977                     ; 706 	LCD_Init(
5977                     ; 707 		LCD_Prescaler_2, 
5977                     ; 708 		LCD_Divider_18, 
5977                     ; 709 		LCD_Duty_1_4,
5977                     ; 710 		LCD_Bias_1_3, 
5977                     ; 711 #if defined (_RC_DR_) || defined (_RC_DW_)
5977                     ; 712 		LCD_VoltageSource_External
5977                     ; 713 #else
5977                     ; 714 		LCD_VoltageSource_Internal
5977                     ; 715 #endif
5977                     ; 716 		);
...
6342                     ; 801 		_blinkId2b = _rid[i*2+1];
...
7260                     	xdef	_lcd_disp_all
7261                     	xdef	_lcd_clear_cnt
7262                     	xdef	_lcd_clear_m
7263                     	xdef	_lcd_clear_info
7264                     	xdef	__plc
7265                     	xdef	__cnt_sub
7266                     	xdef	__cnt_host
7267                     	xdef	__lpm
7268                     	xdef	__temp_offset
7269                     	xdef	__po_type_pb
7270                     	xdef	__po_type_xl
7271                     	xdef	__po_type
7272                     	xdef	__len
7273                     	xdef	__freset
7274                     	xdef	__mir2
7275                     	xdef	__mir1
7276                     	xdef	__cntl_tab
7277                     	xdef	__cntl_2motor
7278                     	xdef	__cntl_op
7279                     	xdef	__link
7280                     	xdef	__hc
7281                     	xdef	__run
