...
uiInfo.plc = 0;
	...
	case 2:
		uiInfo.cnt = 4;
		uiInfo.valve = 6;
		uiInfo.valve_len[0] = 135;
		uiInfo.valve_len[1] = 140;
		uiInfo.valve_len[2] = 145;
		uiInfo.valve_len[3] = 145;
		uiInfo.valve_len[4] = 150;
		uiInfo.valve_len[5] = 145;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 1;
		uiInfo.valve_rc[2] = 2;
		uiInfo.valve_rc[3] = 2;
	...
	case 4:
		...
		uiInfo.valve_len[0] = 135;
		uiInfo.valve_len[1] = 135;
		uiInfo.valve_len[2] = 150;
		uiInfo.valve_len[3] = 150;
		uiInfo.valve_len[4] = 150;
		uiInfo.valve_len[5] = 140;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 1;
		uiInfo.valve_rc[2] = 2;
		uiInfo.valve_rc[3] = 2;
