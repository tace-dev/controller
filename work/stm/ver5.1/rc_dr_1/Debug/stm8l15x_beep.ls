 ...
 383                     ; 216   BEEP->CSR2 &= (uint8_t)(~BEEP_CSR2_BEEPDIV); /* Clear bits */
 385  0013 c650f3        	ld	a,20723
 386  0016 a4e0          	and	a,#224
 387  0018 c750f3        	ld	20723,a
 388                     ; 218   A = (uint16_t)(lsifreqkhz >> 3U); /* Division by 8, keep integer part only */
 390  001b 54            	srlw	x
 391  001c 54            	srlw	x
 392  001d 54            	srlw	x
 393  001e 1f05          	ldw	(OFST-1,sp),x
 395                     ; 220   if ((8U * A) >= ((lsifreqkhz - (8U * A)) * (1U + (2U * A))))
 397  0020 58            	sllw	x
 398  0021 58            	sllw	x
 399  0022 58            	sllw	x
 ...
 417                     ; 222     BEEP->CSR2 |= (uint8_t)(A - 2U);
 419  0044 a002          	sub	a,#2
 421  0046 2001          	jra	L151
 422  0048               L741:
 423                     ; 226     BEEP->CSR2 |= (uint8_t)(A - 1U);
 425  0048 4a            	dec	a
 426  0049               L151:
