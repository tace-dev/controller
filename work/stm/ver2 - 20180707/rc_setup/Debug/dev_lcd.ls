...
3706  002e 85            	popw	x
3707  002f 81            	ret
3749                     ; 367 LCD_CLEAR_FUNC(lcd_clear_info, 3, _info)
3750                     .text:	section	.text,new
3751  0000               _lcd_clear_info:
...
3764  0007 d601de        	ld	a,(__info,x)
...
3787  002a a103          	cp	a,#3
3788  002c 25d5          	jrult	L7621
3792  002e 85            	popw	x
3793  002f 81            	ret
3835                     ; 375 LCD_CLEAR_FUNC(lcd_clear_rid, 16, _rid)
3836                     .text:	section	.text,new
3837  0000               _lcd_clear_rid:
...
3873  002a a110          	cp	a,#16
3874  002c 25d5          	jrult	L3131
3878  002e 85            	popw	x
3879  002f 81            	ret
3921                     ; 376 LCD_CLEAR_FUNC(lcd_clear_n, 35, _n)
3922                     .text:	section	.text,new
3923  0000               _lcd_clear_n:
...
3959  002a a123          	cp	a,#35
3960  002c 25d5          	jrult	L7331
3964  002e 85            	popw	x
3965  002f 81            	ret
4007                     ; 378 LCD_CLEAR_FUNC(lcd_clear_m, 3, _nm)
...
4050  002e 85            	popw	x
4051  002f 81            	ret
4093                     ; 379 LCD_CLEAR_FUNC(lcd_clear_cnt, 6, _ncnt)
...
4136  002e 85            	popw	x
4137  002f 81            	ret
4186                     ; 381 void	lcd_clear_npos(uint8_t pos, uint8_t type)
4186                     ; 382 {
...
4374  0013 84            	pop	a
4375  0014 81            	ret
4422                     ; 406 uint8_t	*lcd_get_npos(uint8_t i)
4422                     ; 407 {
...
4481  002d 81            	ret
4548                     ; 428 void	lcd_disp_n(uint8_t pos, uint8_t n)
4548                     ; 429 {
...
4633  005d 81            	ret
4690                     ; 448 void	lcd_disp_err(uint8_t n)
4690                     ; 449 {
...
4702                     ; 453 	lcd_clear_n();
4704  0007 cd0000        	call	_lcd_clear_n
4706                     ; 454 	p = error_type==1 ? _nerrBr : _nerr;
...
4717                     ; 455 	for( i=0; i<7; i++ )
4719  001b 0f04          	clr	(OFST+0,sp)
4720  001d               L7261:
4721                     ; 457 		LCD_BIT_SET(p[i]);
...
4772  0060               L3061:
4773                     ; 461 Print:		
4773                     ; 462 //		LCD_BIT_SET(bCOL);
4773                     ; 463 		lcd_disp_n(2, n/10);
...
4807  0082 81            	ret
4864                     ; 473 void	lcd_disp_rid(uint8_t id, uint8_t mode, uint8_t multi)
4864                     ; 474 {
...
4972  0085 81            	ret
5021                     ; 520 void	lcd_clear_rid_n(uint8_t id, uint8_t mode)
5021                     ; 521 {
...
5097  005a 81            	ret
5138                     ; 536 void	lcd_disp_cmd(uint8_t cmd, uint8_t mode, uint8_t multi)
5138                     ; 537 {
...
5166  001e 84            	pop	a
5167  001f 81            	ret
5202                     ; 552 void	lcd_disp_info_fire(uint8_t mode)
5202                     ; 553 {
...
5377                     ; 577 		lcd_clear_info();
5379  000a cd0000        	call	_lcd_clear_info
5381  000d               L5202:
5382                     ; 582 	j = _info[info];
...
5435  0000               ___i:
5436  0000 00            	dc.b	0
5476                     ; 601 void	lcd_disp(uint8_t id, uint8_t enable)
5476                     ; 602 {
...
5543  0047               L1502:
5544                     ; 617 		LCD->RAM[LCD_RAMRegister_1] &= (uint8_t)(~id);
...
5620  0018 84            	pop	a
5621  0019 81            	ret
5653                     ; 631 void	lcd_cntl(uint8_t cmd, uint8_t param)
5653                     ; 632 {
5654                     .text:	section	.text,new
5655  0000               _lcd_cntl:
5659                     ; 651 }
5662  0000 81            	ret
5685                     ; 653 void	systemLcdClear(void)
5685                     ; 654 {
5686                     .text:	section	.text,new
5687  0000               _systemLcdClear:
5691                     ; 655 	LCD->CR1 = LCD_CR1_RESET_VALUE;
5693  0000 725f5400      	clr	21504
5694                     ; 656 	LCD->CR2 = LCD_CR2_RESET_VALUE;
5696  0004 725f5401      	clr	21505
5697                     ; 657 	LCD->CR3 = LCD_CR3_RESET_VALUE;
5699  0008 725f5402      	clr	21506
5700                     ; 658 	LCD->FRQ = LCD_FRQ_RESET_VALUE;
5702  000c 725f5403      	clr	21507
5703                     ; 660 	LCD->CR4 = LCD_CR4_RESET_VALUE;
5705  0010 725f542f      	clr	21551
5706                     ; 661 }
5709  0014 81            	ret
5742                     ; 698 void	systemLcd(void)
5742                     ; 699 {
5743                     .text:	section	.text,new
5744  0000               _systemLcd:
5748                     ; 700 	CLK_PeripheralClockConfig(CLK_Peripheral_LCD, ENABLE);
5750  0000 ae1301        	ldw	x,#4865
5751  0003 cd0000        	call	_CLK_PeripheralClockConfig
5753                     ; 701 	CLK_RTCClockConfig(CLK_RTCCLKSource_LSI, CLK_RTCCLKDiv_1);
5755  0006 ae0400        	ldw	x,#1024
5756  0009 cd0000        	call	_CLK_RTCClockConfig
5758                     ; 702 	CLK_PeripheralClockConfig(CLK_Peripheral_RTC, ENABLE);
5760  000c ae1201        	ldw	x,#4609
5761  000f cd0000        	call	_CLK_PeripheralClockConfig
5763                     ; 704 	systemLcdClear();
5765  0012 cd0000        	call	_systemLcdClear
5767                     ; 706 	LCD_Init(
5767                     ; 707 		LCD_Prescaler_2, 
5767                     ; 708 		LCD_Divider_18, 
5767                     ; 709 		LCD_Duty_1_4,
5767                     ; 710 		LCD_Bias_1_3, 
5767                     ; 711 #if defined (_RC_DR_) || defined (_RC_DW_)
5767                     ; 712 		LCD_VoltageSource_External
5767                     ; 713 #else
5767                     ; 714 		LCD_VoltageSource_Internal
5767                     ; 715 #endif
5767                     ; 716 		);
...
6128                     ; 801 		_blinkId2b = _rid[i*2+1];
...
6320  00b5               L5722:
6321                     ; 840 					LCD_BIT_CLEAR(_blinkId2);
...
6360  00f8               L1032:
6361                     ; 847 					LCD_BIT_SET(_blinkId2);
