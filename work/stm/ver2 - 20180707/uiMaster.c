...
{
	lcd_clear_btn();
	if( i == 0x01 )			{	LCD_BIT_SET(bT6);	/*	(0)난방*/	}
	else if( i == 0x02 )	{	LCD_BIT_SET(bT7);	/*	(1)외출*/	}
//	else if( i == 0x04 )	{	LCD_BIT_SET(bT7);	/*	(2)정지*/	}
	else if( i == 0x08 )	{	LCD_BIT_SET(bT14);	/*	(2)예약*/	}
	else if( i == 0x10 )	{	LCD_BIT_SET(bT18);	/*	(2)반복*/	}
}
...
//			disp_status_loop_init();
		...
		*/
		...
		else if( _dsCount == 15 )			//	N/Out
		{
			...
			else if( key==4 ) _GOTO(152)		//	MODE	
			else if( key==8 )	_GOTO(101)	//	REMOTE
			else if( key==16 )	_DN
			else if( key==32 )	_UP				
			_disp_temp = 1;
		...
		else if( _dsCount == 151 )			//	OUT/Nan
		{
			...
			else if( key==4 )	_GOTO(/*2*/154)	//	MODE
			else if( key==8 )	_GOTO(101)	//	REMOTE
		...
		else if( _dsCount == 154 )			//	MODE_4
		{
			...
			else if( key==4 )	_GOTO(155)	//	MODE_5
			else if( key==8 )	_GOTO(101)	//	REMOTE
			else if( key==16 )	_DN
			else if( key==32 )	_UP
//			_disp_temp = 1;
