...
{
	lcd_clear_btn();
	if( i == 1 )		{	_disp_mode = 0x02;	LCD_BIT_SET(/*bS9*/bP20);	/*	ø‹√‚*/	}
	else if( i == 0 )	{	_disp_mode = 0x04;	LCD_BIT_SET(/*bS10*/bP13);	/*	¡§¡ˆ*/	}
	else if( i == 2 )	{	_disp_mode = 0x01;	LCD_BIT_SET(/*bS6*/bP15);	/*	≥≠πÊ*/	}
	else if( i == 3 )	{	_disp_mode = 0x08;	LCD_BIT_SET(/*bS7*/bP10);	/*	øπæ‡*/	}
	else if( i == 4 )	{	_disp_mode = 0x10;	LCD_BIT_SET(/*bS8*/bP9);	/*	π›∫π*/	}
