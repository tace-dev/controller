...
start 00008183 end 00009d6e length  7147 segment .text
...
void	phase_excite(uint8_t phase)
{
	switch(phase)
	{
		...
		case 0: case 4: _H_X1 _H_X2 _L_Y1 _L_Y2 break;		
		case 1: case 5: _L_X1 _H_X2 _H_Y1 _L_Y2 break;
		case 2: case 6: _L_X1 _L_X2 _H_Y1 _H_Y2 break;
		case 3: case 7: _H_X1 _L_X2 _L_Y1 _H_Y2 break;
}
#endif
#if (EXCITATION_TYPE == TYPE_12Phase)
		case 0: _H_X1 _H_X2 _L_Y1 _L_Y2 break;
		case 1: _L_X1 _H_X2 _L_Y1 _L_Y2 break;		
		case 2: _L_X1 _H_X2 _H_Y1 _L_Y2 break;
		case 3: _L_X1 _L_X2 _H_Y1 _L_Y2 break;
		case 4: _L_X1 _L_X2 _H_Y1 _H_Y2 break;
		...
		case 2: case 3: _L_X1 _H_X2 _L_Y1 _L_Y2 break;
		case 4: case 5: _L_X1 _L_X2 _H_Y1 _L_Y2 break;
...
//void AdcService()	
		...
		{
			Timer.PwmUpdate = (Ticks_1mS>2000) ? Ticks_1mS - 2000 : 65535 - 2000 + Ticks_1mS;						
			Drive.Step = 0;
		}
		else
		{
