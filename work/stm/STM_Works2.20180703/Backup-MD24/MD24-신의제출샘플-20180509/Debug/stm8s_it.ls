 ...
 668                     ; 454 }
 671  0054 80            	iret	
 696                     ; 479 INTERRUPT_HANDLER(TIM4_UPD_OVF_IRQHandler, 23)
 696                     ; 480 {
 697                     	switch	.text
 698  0055               f_TIM4_UPD_OVF_IRQHandler:
 700  0055 8a            	push	cc
 701  0056 84            	pop	a
 702  0057 a4bf          	and	a,#191
 703  0059 88            	push	a
 704  005a 86            	pop	cc
 705  005b 3b0002        	push	c_x+2
 706  005e be00          	ldw	x,c_x
 707  0060 89            	pushw	x
 708  0061 3b0002        	push	c_y+2
 709  0064 be00          	ldw	x,c_y
 710  0066 89            	pushw	x
 713                     ; 485 	OnTimer4();
 715  0067 cd0000        	call	_OnTimer4
 717                     ; 487   TIM4_ClearITPendingBit(TIM4_IT_UPDATE);
 719  006a a601          	ld	a,#1
 720  006c cd0000        	call	_TIM4_ClearITPendingBit
 722                     ; 489 }
 725  006f 85            	popw	x
 726  0070 bf00          	ldw	c_y,x
 727  0072 320002        	pop	c_y+2
 728  0075 85            	popw	x
 729  0076 bf00          	ldw	c_x,x
 730  0078 320002        	pop	c_x+2
 731  007b 80            	iret	
 754                     ; 497 INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
 754                     ; 498 {
 755                     	switch	.text
 756  007c               f_EEPROM_EEC_IRQHandler:
 760                     ; 502 }
 763  007c 80            	iret	
 775                     	xref	_OnCaptureOVTim2
 776                     	xref	_OnCaptureTim2
 777                     	xref	_OnTimer4
 778                     	xdef	f_EEPROM_EEC_IRQHandler
 779                     	xdef	f_TIM4_UPD_OVF_IRQHandler
 780                     	xdef	f_ADC1_IRQHandler
 781                     	xdef	f_I2C_IRQHandler
 782                     	xdef	f_UART1_RX_IRQHandler
 783                     	xdef	f_UART1_TX_IRQHandler
 784                     	xdef	f_TIM2_CAP_COM_IRQHandler
 785                     	xdef	f_TIM2_UPD_OVF_BRK_IRQHandler
 786                     	xdef	f_TIM1_UPD_OVF_TRG_BRK_IRQHandler
 787                     	xdef	f_TIM1_CAP_COM_IRQHandler
 788                     	xdef	f_SPI_IRQHandler
 789                     	xdef	f_EXTI_PORTE_IRQHandler
 790                     	xdef	f_EXTI_PORTD_IRQHandler
 791                     	xdef	f_EXTI_PORTC_IRQHandler
 792                     	xdef	f_EXTI_PORTB_IRQHandler
 793                     	xdef	f_EXTI_PORTA_IRQHandler
 794                     	xdef	f_CLK_IRQHandler
 795                     	xdef	f_AWU_IRQHandler
 796                     	xdef	f_TLI_IRQHandler
 797                     	xdef	f_TRAP_IRQHandler
 798                     	xdef	f_NonHandledInterrupt
 799                     	xref	_TIM4_ClearITPendingBit
 800                     	xref.b	c_x
 801                     	xref.b	c_y
 820                     	end
