 ...
 138                     ; 91 			iouart_Set_Packet(0);
 140  002f 4f            	clr	a
 141  0030 cd0000        	call	_iouart_Set_Packet
 143                     ; 92 			iouart_Pkt_Start();
 ...
 490  014b               L541:
 491                     ; 589 	factory2wire();
 493  014b cd0000        	call	_factory2wire
 495                     ; 590 }
 498  014e 84            	pop	a
 499  014f 81            	ret	
 531                     ; 593 void	_factoryCntl(uint8_t i)
 531                     ; 594 {
 532                     	switch	.text
 533  0150               __factoryCntl:
 537                     ; 603 }
 540  0150 81            	ret	
 574                     ; 816 uint8_t factory(uint8_t mode)
 574                     ; 817 {
 575                     	switch	.text
 576  0151               _factory:
 580                     ; 818 	timerCalc();
