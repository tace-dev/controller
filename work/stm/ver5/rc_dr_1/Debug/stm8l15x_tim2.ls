 ...
 331                     ; 251 }
 334  0021 81            	ret	
 402                     ; 271 void TIM2_PrescalerConfig(TIM2_Prescaler_TypeDef Prescaler,
 402                     ; 272                           TIM2_PSCReloadMode_TypeDef TIM2_PSCReloadMode)
 402                     ; 273 {
 403                     .text:	section	.text,new
 404  0000               _TIM2_PrescalerConfig:
 408                     ; 275   assert_param(IS_TIM2_PRESCALER(Prescaler));
 410                     ; 276   assert_param(IS_TIM2_PRESCALER_RELOAD(TIM2_PSCReloadMode));
 412                     ; 279   TIM2->PSCR = (uint8_t)(Prescaler);
 414  0000 9e            	ld	a,xh
 415  0001 c7525e        	ld	21086,a
 416                     ; 282   if (TIM2_PSCReloadMode == TIM2_PSCReloadMode_Immediate)
 418  0004 9f            	ld	a,xl
 419  0005 4a            	dec	a
 420  0006 2605          	jrne	L541
 421                     ; 284     TIM2->EGR |= TIM_EGR_UG ;
 423  0008 72105258      	bset	21080,#0
 426  000c 81            	ret	
 427  000d               L541:
 428                     ; 288     TIM2->EGR &= (uint8_t)(~TIM_EGR_UG) ;
 430  000d 72115258      	bres	21080,#0
 431                     ; 290 }
 434  0011 81            	ret	
 477                     ; 303 void TIM2_CounterModeConfig(TIM2_CounterMode_TypeDef TIM2_CounterMode)
 477                     ; 304 {
 ...
 488                     ; 308   assert_param(IS_TIM2_COUNTER_MODE(TIM2_CounterMode));
 490                     ; 310   tmpcr1 = TIM2->CR1;
 ...
 502                     ; 318   TIM2->CR1 = tmpcr1;
 504  0009 c75250        	ld	21072,a
 505                     ; 319 }
 508  000c 85            	popw	x
 509  000d 81            	ret	
 541                     ; 327 void TIM2_SetCounter(uint16_t Counter)
 541                     ; 328 {
 542                     .text:	section	.text,new
 543  0000               _TIM2_SetCounter:
 547                     ; 331   TIM2->CNTRH = (uint8_t)(Counter >> 8);
 549  0000 9e            	ld	a,xh
 550  0001 c7525c        	ld	21084,a
 551                     ; 332   TIM2->CNTRL = (uint8_t)(Counter);
 553  0004 9f            	ld	a,xl
 554  0005 c7525d        	ld	21085,a
 555                     ; 333 }
 558  0008 81            	ret	
 590                     ; 341 void TIM2_SetAutoreload(uint16_t Autoreload)
 590                     ; 342 {
 591                     .text:	section	.text,new
 592  0000               _TIM2_SetAutoreload:
 596                     ; 344   TIM2->ARRH = (uint8_t)(Autoreload >> 8);
 598  0000 9e            	ld	a,xh
 599  0001 c7525f        	ld	21087,a
 600                     ; 345   TIM2->ARRL = (uint8_t)(Autoreload);
 602  0004 9f            	ld	a,xl
 603  0005 c75260        	ld	21088,a
 604                     ; 346 }
 607  0008 81            	ret	
 653                     ; 353 uint16_t TIM2_GetCounter(void)
 653                     ; 354 {
 ...
 663                     ; 358   tmpcntrh = TIM2->CNTRH;
 665  0002 c6525c        	ld	a,21084
 666  0005 6b02          	ld	(OFST-2,sp),a
 668                     ; 359   tmpcntrl = TIM2->CNTRL;
 ...
 694  001c 81            	ret	
 718                     ; 380 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
 718                     ; 381 {
 719                     .text:	section	.text,new
 720  0000               _TIM2_GetPrescaler:
 724                     ; 383   return ((TIM2_Prescaler_TypeDef)TIM2->PSCR);
 726  0000 c6525e        	ld	a,21086
 729  0003 81            	ret	
 785                     ; 393 void TIM2_UpdateDisableConfig(FunctionalState NewState)
 785                     ; 394 {
 ...
 797                     ; 401     TIM2->CR1 |= TIM_CR1_UDIS;
 799  0003 72125250      	bset	21072,#1
 802  0007 81            	ret	
 803  0008               L772:
 804                     ; 405     TIM2->CR1 &= (uint8_t)(~TIM_CR1_UDIS);
 806  0008 72135250      	bres	21072,#1
 807                     ; 407 }
 810  000c 81            	ret	
 868                     ; 417 void TIM2_UpdateRequestConfig(TIM2_UpdateSource_TypeDef TIM2_UpdateSource)
 868                     ; 418 {
 869                     .text:	section	.text,new
 870  0000               _TIM2_UpdateRequestConfig:
 874                     ; 420   assert_param(IS_TIM2_UPDATE_SOURCE(TIM2_UpdateSource));
 876                     ; 423   if (TIM2_UpdateSource == TIM2_UpdateSource_Regular)
 878  0000 4a            	dec	a
 879  0001 2605          	jrne	L133
 880                     ; 425     TIM2->CR1 |= TIM_CR1_URS ;
 882  0003 72145250      	bset	21072,#2
 885  0007 81            	ret	
 886  0008               L133:
 887                     ; 429     TIM2->CR1 &= (uint8_t)(~TIM_CR1_URS);
 889  0008 72155250      	bres	21072,#2
 890                     ; 431 }
 893  000c 81            	ret	
 929                     ; 439 void TIM2_ARRPreloadConfig(FunctionalState NewState)
 929                     ; 440 {
 ...
 941                     ; 447     TIM2->CR1 |= TIM_CR1_ARPE;
 943  0003 721e5250      	bset	21072,#7
 946  0007 81            	ret	
 947  0008               L353:
 948                     ; 451     TIM2->CR1 &= (uint8_t)(~TIM_CR1_ARPE);
 950  0008 721f5250      	bres	21072,#7
 951                     ; 453 }
 954  000c 81            	ret	
1011                     ; 463 void TIM2_SelectOnePulseMode(TIM2_OPMode_TypeDef TIM2_OPMode)
1011                     ; 464 {
1012                     .text:	section	.text,new
1013  0000               _TIM2_SelectOnePulseMode:
1017                     ; 466   assert_param(IS_TIM2_OPM_MODE(TIM2_OPMode));
1019                     ; 469   if (TIM2_OPMode == TIM2_OPMode_Single)
1021  0000 4a            	dec	a
1022  0001 2605          	jrne	L504
1023                     ; 471     TIM2->CR1 |= TIM_CR1_OPM ;
1025  0003 72165250      	bset	21072,#3
1028  0007 81            	ret	
1029  0008               L504:
1030                     ; 475     TIM2->CR1 &= (uint8_t)(~TIM_CR1_OPM);
1032  0008 72175250      	bres	21072,#3
1033                     ; 477 }
1036  000c 81            	ret	
1071                     ; 485 void TIM2_Cmd(FunctionalState NewState)
1071                     ; 486 {
...
1083                     ; 493     TIM2->CR1 |= TIM_CR1_CEN;
1085  0003 72105250      	bset	21072,#0
1088  0007 81            	ret	
1089  0008               L724:
1090                     ; 497     TIM2->CR1 &= (uint8_t)(~TIM_CR1_CEN);
1092  0008 72115250      	bres	21072,#0
1093                     ; 499 }
1096  000c 81            	ret	
1290                     ; 575 void TIM2_OC1Init(TIM2_OCMode_TypeDef TIM2_OCMode,
1290                     ; 576                   TIM2_OutputState_TypeDef TIM2_OutputState,
1290                     ; 577                   uint16_t TIM2_Pulse,
1290                     ; 578                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity,
1290                     ; 579                   TIM2_OCIdleState_TypeDef TIM2_OCIdleState)
1290                     ; 580 {
...
1301                     ; 584   assert_param(IS_TIM2_OC_MODE(TIM2_OCMode));
1303                     ; 585   assert_param(IS_TIM2_OUTPUT_STATE(TIM2_OutputState));
1305                     ; 586   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
1307                     ; 587   assert_param(IS_TIM2_OCIDLE_STATE(TIM2_OCIdleState));
1309                     ; 589   tmpccmr1 = TIM2->CCMR1;
1311  0002 c65259        	ld	a,21081
1312  0005 6b01          	ld	(OFST+0,sp),a
1314                     ; 592   TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
...
1322                     ; 597   tmpccmr1 |= (uint8_t)TIM2_OCMode;
1324  000f 9e            	ld	a,xh
1325  0010 1a01          	or	a,(OFST+0,sp)
1326  0012 6b01          	ld	(OFST+0,sp),a
1328                     ; 599   TIM2->CCMR1 = tmpccmr1;
1330  0014 c75259        	ld	21081,a
1331                     ; 602   if (TIM2_OutputState == TIM2_OutputState_Enable)
1333  0017 9f            	ld	a,xl
1334  0018 4a            	dec	a
1335  0019 2606          	jrne	L145
1336                     ; 604     TIM2->CCER1 |= TIM_CCER1_CC1E;
1338  001b 7210525b      	bset	21083,#0
1340  001f 2004          	jra	L345
1341  0021               L145:
1342                     ; 608     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1344  0021 7211525b      	bres	21083,#0
1345  0025               L345:
1346                     ; 612   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
1348  0025 7b08          	ld	a,(OFST+7,sp)
1349  0027 4a            	dec	a
1350  0028 2606          	jrne	L545
1351                     ; 614     TIM2->CCER1 |= TIM_CCER1_CC1P;
1353  002a 7212525b      	bset	21083,#1
1355  002e 2004          	jra	L745
1356  0030               L545:
1357                     ; 618     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
1359  0030 7213525b      	bres	21083,#1
1360  0034               L745:
1361                     ; 622   if (TIM2_OCIdleState == TIM2_OCIdleState_Set)
1363  0034 7b09          	ld	a,(OFST+8,sp)
1364  0036 4a            	dec	a
1365  0037 2606          	jrne	L155
1366                     ; 624     TIM2->OISR |= TIM_OISR_OIS1;
1368  0039 72105266      	bset	21094,#0
1370  003d 2004          	jra	L355
1371  003f               L155:
1372                     ; 628     TIM2->OISR &= (uint8_t)(~TIM_OISR_OIS1);
1374  003f 72115266      	bres	21094,#0
1375  0043               L355:
1376                     ; 632   TIM2->CCR1H = (uint8_t)(TIM2_Pulse >> 8);
1378  0043 7b06          	ld	a,(OFST+5,sp)
1379  0045 c75261        	ld	21089,a
1380                     ; 633   TIM2->CCR1L = (uint8_t)(TIM2_Pulse);
1382  0048 7b07          	ld	a,(OFST+6,sp)
1383  004a c75262        	ld	21090,a
1384                     ; 634 }
1387  004d 5b03          	addw	sp,#3
1388  004f 81            	ret	
1467                     ; 661 void TIM2_OC2Init(TIM2_OCMode_TypeDef TIM2_OCMode,
1467                     ; 662                   TIM2_OutputState_TypeDef TIM2_OutputState,
1467                     ; 663                   uint16_t TIM2_Pulse,
1467                     ; 664                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity,
1467                     ; 665                   TIM2_OCIdleState_TypeDef TIM2_OCIdleState)
1467                     ; 666 {
...
1478                     ; 670   assert_param(IS_TIM2_OC_MODE(TIM2_OCMode));
1480                     ; 671   assert_param(IS_TIM2_OUTPUT_STATE(TIM2_OutputState));
1482                     ; 672   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
1484                     ; 673   assert_param(IS_TIM2_OCIDLE_STATE(TIM2_OCIdleState));
1486                     ; 675   tmpccmr2 = TIM2->CCMR2;
1488  0002 c6525a        	ld	a,21082
1489  0005 6b01          	ld	(OFST+0,sp),a
1491                     ; 678   TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
...
1499                     ; 684   tmpccmr2 |= (uint8_t)TIM2_OCMode;
1501  000f 9e            	ld	a,xh
1502  0010 1a01          	or	a,(OFST+0,sp)
1503  0012 6b01          	ld	(OFST+0,sp),a
1505                     ; 686   TIM2->CCMR2 = tmpccmr2;
1507  0014 c7525a        	ld	21082,a
1508                     ; 689   if (TIM2_OutputState == TIM2_OutputState_Enable)
1510  0017 9f            	ld	a,xl
1511  0018 4a            	dec	a
1512  0019 2606          	jrne	L316
1513                     ; 691     TIM2->CCER1 |= TIM_CCER1_CC2E;
1515  001b 7218525b      	bset	21083,#4
1517  001f 2004          	jra	L516
1518  0021               L316:
1519                     ; 695     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1521  0021 7219525b      	bres	21083,#4
1522  0025               L516:
1523                     ; 699   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
1525  0025 7b08          	ld	a,(OFST+7,sp)
1526  0027 4a            	dec	a
1527  0028 2606          	jrne	L716
1528                     ; 701     TIM2->CCER1 |= TIM_CCER1_CC2P;
1530  002a 721a525b      	bset	21083,#5
1532  002e 2004          	jra	L126
1533  0030               L716:
1534                     ; 705     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P);
1536  0030 721b525b      	bres	21083,#5
1537  0034               L126:
1538                     ; 710   if (TIM2_OCIdleState == TIM2_OCIdleState_Set)
1540  0034 7b09          	ld	a,(OFST+8,sp)
1541  0036 4a            	dec	a
1542  0037 2606          	jrne	L326
1543                     ; 712     TIM2->OISR |= TIM_OISR_OIS2;
1545  0039 72145266      	bset	21094,#2
1547  003d 2004          	jra	L526
1548  003f               L326:
1549                     ; 716     TIM2->OISR &= (uint8_t)(~TIM_OISR_OIS2);
1551  003f 72155266      	bres	21094,#2
1552  0043               L526:
1553                     ; 720   TIM2->CCR2H = (uint8_t)(TIM2_Pulse >> 8);
1555  0043 7b06          	ld	a,(OFST+5,sp)
1556  0045 c75263        	ld	21091,a
1557                     ; 721   TIM2->CCR2L = (uint8_t)(TIM2_Pulse);
1559  0048 7b07          	ld	a,(OFST+6,sp)
1560  004a c75264        	ld	21092,a
1561                     ; 722 }
1564  004d 5b03          	addw	sp,#3
1565  004f 81            	ret	
1763                     ; 751 void TIM2_BKRConfig(TIM2_OSSIState_TypeDef TIM2_OSSIState,
1763                     ; 752                     TIM2_LockLevel_TypeDef TIM2_LockLevel,
1763                     ; 753                     TIM2_BreakState_TypeDef TIM2_BreakState,
1763                     ; 754                     TIM2_BreakPolarity_TypeDef TIM2_BreakPolarity,
1763                     ; 755                     TIM2_AutomaticOutput_TypeDef TIM2_AutomaticOutput)
1763                     ; 756 
1763                     ; 757 {
...
1772                     ; 759   assert_param(IS_TIM2_OSSI_STATE(TIM2_OSSIState));
1774                     ; 760   assert_param(IS_TIM2_LOCK_LEVEL(TIM2_LockLevel));
1776                     ; 761   assert_param(IS_TIM2_BREAK_STATE(TIM2_BreakState));
1778                     ; 762   assert_param(IS_TIM2_BREAK_POLARITY(TIM2_BreakPolarity));
1780                     ; 763   assert_param(IS_TIM2_AUTOMATIC_OUTPUT_STATE(TIM2_AutomaticOutput));
1782                     ; 769   TIM2->BKR = (uint8_t)((uint8_t)((uint8_t)((uint8_t)((uint8_t)TIM2_OSSIState | (uint8_t)TIM2_LockLevel) | \
1782                     ; 770                                   (uint8_t)((uint8_t)TIM2_BreakState | (uint8_t)TIM2_BreakPolarity)) | \
1782                     ; 771                                   TIM2_AutomaticOutput));
...
1797  0014 81            	ret	
1833                     ; 780 void TIM2_CtrlPWMOutputs(FunctionalState NewState)
1833                     ; 781 {
...
1855                     ; 795 }
1858  000c 81            	ret	
1923                     ; 815 void TIM2_SelectOCxM(TIM2_Channel_TypeDef TIM2_Channel,
1923                     ; 816                      TIM2_OCMode_TypeDef TIM2_OCMode)
1923                     ; 817 {
1924                     .text:	section	.text,new
1925  0000               _TIM2_SelectOCxM:
1927  0000 89            	pushw	x
1928       00000000      OFST:	set	0
1931                     ; 819   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
1933                     ; 820   assert_param(IS_TIM2_OCM(TIM2_OCMode));
1935                     ; 822   if (TIM2_Channel == TIM2_Channel_1)
1937  0001 9e            	ld	a,xh
1938  0002 4d            	tnz	a
1939  0003 2615          	jrne	L5101
1940                     ; 825     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1942  0005 7211525b      	bres	21083,#0
1943                     ; 828     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCM);
1945  0009 c65259        	ld	a,21081
1946  000c a48f          	and	a,#143
1947  000e c75259        	ld	21081,a
1948                     ; 831     TIM2->CCMR1 |= (uint8_t)TIM2_OCMode;
1950  0011 9f            	ld	a,xl
1951  0012 ca5259        	or	a,21081
1952  0015 c75259        	ld	21081,a
1954  0018 2014          	jra	L7101
1955  001a               L5101:
1956                     ; 836     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1958  001a 7219525b      	bres	21083,#4
1959                     ; 839     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCM);
1961  001e c6525a        	ld	a,21082
1962  0021 a48f          	and	a,#143
1963  0023 c7525a        	ld	21082,a
1964                     ; 842     TIM2->CCMR2 |= (uint8_t)TIM2_OCMode;
...
1973  002e 85            	popw	x
1974  002f 81            	ret	
2006                     ; 852 void TIM2_SetCompare1(uint16_t Compare)
2006                     ; 853 {
2007                     .text:	section	.text,new
2008  0000               _TIM2_SetCompare1:
2012                     ; 855   TIM2->CCR1H = (uint8_t)(Compare >> 8);
2014  0000 9e            	ld	a,xh
2015  0001 c75261        	ld	21089,a
2016                     ; 856   TIM2->CCR1L = (uint8_t)(Compare);
2018  0004 9f            	ld	a,xl
2019  0005 c75262        	ld	21090,a
2020                     ; 857 }
2023  0008 81            	ret	
2055                     ; 865 void TIM2_SetCompare2(uint16_t Compare)
2055                     ; 866 {
2056                     .text:	section	.text,new
2057  0000               _TIM2_SetCompare2:
2061                     ; 868   TIM2->CCR2H = (uint8_t)(Compare >> 8);
2063  0000 9e            	ld	a,xh
2064  0001 c75263        	ld	21091,a
2065                     ; 869   TIM2->CCR2L = (uint8_t)(Compare);
2067  0004 9f            	ld	a,xl
2068  0005 c75264        	ld	21092,a
2069                     ; 870 }
2072  0008 81            	ret	
2137                     ; 880 void TIM2_ForcedOC1Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2137                     ; 881 {
...
2148                     ; 885   assert_param(IS_TIM2_FORCED_ACTION(TIM2_ForcedAction));
2150                     ; 887   tmpccmr1 = TIM2->CCMR1;
2152  0002 c65259        	ld	a,21081
2154                     ; 890   tmpccmr1 &= (uint8_t)(~TIM_CCMR_OCM);
2156  0005 a48f          	and	a,#143
2158                     ; 893   tmpccmr1 |= (uint8_t)TIM2_ForcedAction;
2160  0007 1a02          	or	a,(OFST+1,sp)
2162                     ; 895   TIM2->CCMR1 = tmpccmr1;
2164  0009 c75259        	ld	21081,a
2165                     ; 896 }
2168  000c 85            	popw	x
2169  000d 81            	ret	
2212                     ; 906 void TIM2_ForcedOC2Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2212                     ; 907 {
...
2223                     ; 911   assert_param(IS_TIM2_FORCED_ACTION(TIM2_ForcedAction));
2225                     ; 913   tmpccmr2 = TIM2->CCMR2;
2227  0002 c6525a        	ld	a,21082
2229                     ; 916   tmpccmr2 &= (uint8_t)(~TIM_CCMR_OCM);
2231  0005 a48f          	and	a,#143
2233                     ; 919   tmpccmr2 |= (uint8_t)TIM2_ForcedAction;
2235  0007 1a02          	or	a,(OFST+1,sp)
2237                     ; 921   TIM2->CCMR2 = tmpccmr2;
2239  0009 c7525a        	ld	21082,a
2240                     ; 922 }
2243  000c 85            	popw	x
2244  000d 81            	ret	
2280                     ; 930 void TIM2_OC1PreloadConfig(FunctionalState NewState)
2280                     ; 931 {
...
2292                     ; 938     TIM2->CCMR1 |= TIM_CCMR_OCxPE ;
2294  0003 72165259      	bset	21081,#3
2297  0007 81            	ret	
2298  0008               L7311:
2299                     ; 942     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2301  0008 72175259      	bres	21081,#3
2302                     ; 944 }
2305  000c 81            	ret	
2341                     ; 952 void TIM2_OC2PreloadConfig(FunctionalState NewState)
2341                     ; 953 {
...
2353                     ; 960     TIM2->CCMR2 |= TIM_CCMR_OCxPE ;
2355  0003 7216525a      	bset	21082,#3
2358  0007 81            	ret	
2359  0008               L1611:
2360                     ; 964     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2362  0008 7217525a      	bres	21082,#3
2363                     ; 966 }
2366  000c 81            	ret	
2401                     ; 974 void TIM2_OC1FastConfig(FunctionalState NewState)
2401                     ; 975 {
...
2413                     ; 982     TIM2->CCMR1 |= TIM_CCMR_OCxFE ;
2415  0003 72145259      	bset	21081,#2
2418  0007 81            	ret	
2419  0008               L3021:
2420                     ; 986     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2422  0008 72155259      	bres	21081,#2
2423                     ; 988 }
2426  000c 81            	ret	
2461                     ; 997 void TIM2_OC2FastConfig(FunctionalState NewState)
2461                     ; 998 {
...
2473                     ; 1005     TIM2->CCMR2 |= TIM_CCMR_OCxFE ;
2475  0003 7214525a      	bset	21082,#2
2478  0007 81            	ret	
2479  0008               L5221:
2480                     ; 1009     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2482  0008 7215525a      	bres	21082,#2
2483                     ; 1011 }
2486  000c 81            	ret	
2522                     ; 1021 void TIM2_OC1PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
2522                     ; 1022 {
2523                     .text:	section	.text,new
2524  0000               _TIM2_OC1PolarityConfig:
2528                     ; 1024   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
2530                     ; 1027   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
2532  0000 4a            	dec	a
2533  0001 2605          	jrne	L7421
2534                     ; 1029     TIM2->CCER1 |= TIM_CCER1_CC1P ;
2536  0003 7212525b      	bset	21083,#1
2539  0007 81            	ret	
2540  0008               L7421:
2541                     ; 1033     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P) ;
2543  0008 7213525b      	bres	21083,#1
2544                     ; 1035 }
2547  000c 81            	ret	
2583                     ; 1045 void TIM2_OC2PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
2583                     ; 1046 {
2584                     .text:	section	.text,new
2585  0000               _TIM2_OC2PolarityConfig:
2589                     ; 1048   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
2591                     ; 1051   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
2593  0000 4a            	dec	a
2594  0001 2605          	jrne	L1721
2595                     ; 1053     TIM2->CCER1 |= TIM_CCER1_CC2P ;
2597  0003 721a525b      	bset	21083,#5
2600  0007 81            	ret	
2601  0008               L1721:
2602                     ; 1057     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
2604  0008 721b525b      	bres	21083,#5
2605                     ; 1059 }
2608  000c 81            	ret	
2653                     ; 1071 void TIM2_CCxCmd(TIM2_Channel_TypeDef TIM2_Channel,
...
2661                     ; 1075   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
2663                     ; 1076   assert_param(IS_FUNCTIONAL_STATE(NewState));
2665                     ; 1078   if (TIM2_Channel == TIM2_Channel_1)
...
2675                     ; 1083       TIM2->CCER1 |= TIM_CCER1_CC1E ;
2677  0009 7210525b      	bset	21083,#0
2679  000d 2014          	jra	L5231
2680  000f               L1231:
2681                     ; 1087       TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E) ;
...
2690                     ; 1096       TIM2->CCER1 |= TIM_CCER1_CC2E;
2692  0019 7218525b      	bset	21083,#4
2694  001d 2004          	jra	L5231
2695  001f               L7231:
2696                     ; 1100       TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E) ;
2698  001f 7219525b      	bres	21083,#4
2699  0023               L5231:
2700                     ; 1103 }
2703  0023 85            	popw	x
2704  0024 81            	ret	
2866                     ; 1181 void TIM2_ICInit(TIM2_Channel_TypeDef TIM2_Channel,
2866                     ; 1182                  TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
2866                     ; 1183                  TIM2_ICSelection_TypeDef TIM2_ICSelection,
2866                     ; 1184                  TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
2866                     ; 1185                  uint8_t TIM2_ICFilter)
2866                     ; 1186 {
2867                     .text:	section	.text,new
2868  0000               _TIM2_ICInit:
2870  0000 89            	pushw	x
2871       00000000      OFST:	set	0
2874                     ; 1188   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
2876                     ; 1190   if (TIM2_Channel == TIM2_Channel_1)
2878  0001 9e            	ld	a,xh
2879  0002 4d            	tnz	a
2880  0003 2614          	jrne	L5241
2881                     ; 1193     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection, TIM2_ICFilter);
...
2891  0011 84            	pop	a
2892                     ; 1196     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
2894  0012 7b06          	ld	a,(OFST+6,sp)
2895  0014 cd0000        	call	_TIM2_SetIC1Prescaler
2898  0017 2012          	jra	L7241
2899  0019               L5241:
2900                     ; 1201     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection, TIM2_ICFilter);
...
2910  0025 84            	pop	a
2911                     ; 1204     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
...
2920  002b 85            	popw	x
2921  002c 81            	ret	
3011                     ; 1232 void TIM2_PWMIConfig(TIM2_Channel_TypeDef TIM2_Channel,
3011                     ; 1233                      TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
3011                     ; 1234                      TIM2_ICSelection_TypeDef TIM2_ICSelection,
3011                     ; 1235                      TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
3011                     ; 1236                      uint8_t TIM2_ICFilter)
3011                     ; 1237 {
...
3020                     ; 1238   uint8_t icpolarity = TIM2_ICPolarity_Rising;
3022                     ; 1239   uint8_t icselection = TIM2_ICSelection_DirectTI;
3024                     ; 1242   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
3026                     ; 1245   if (TIM2_ICPolarity == TIM2_ICPolarity_Rising)
3028  0002 9f            	ld	a,xl
3029  0003 4d            	tnz	a
3030  0004 2605          	jrne	L1741
3031                     ; 1247     icpolarity = TIM2_ICPolarity_Falling;
3033  0006 4c            	inc	a
3034  0007 6b01          	ld	(OFST-1,sp),a
3037  0009 2002          	jra	L3741
3038  000b               L1741:
3039                     ; 1251     icpolarity = TIM2_ICPolarity_Rising;
3041  000b 0f01          	clr	(OFST-1,sp)
3043  000d               L3741:
3044                     ; 1255   if (TIM2_ICSelection == TIM2_ICSelection_DirectTI)
3046  000d 7b07          	ld	a,(OFST+5,sp)
3047  000f 4a            	dec	a
3048  0010 2604          	jrne	L5741
3049                     ; 1257     icselection = TIM2_ICSelection_IndirectTI;
3051  0012 a602          	ld	a,#2
3053  0014 2002          	jra	L7741
3054  0016               L5741:
3055                     ; 1261     icselection = TIM2_ICSelection_DirectTI;
3057  0016 a601          	ld	a,#1
3058  0018               L7741:
3059  0018 6b02          	ld	(OFST+0,sp),a
3061                     ; 1264   if (TIM2_Channel == TIM2_Channel_1)
3063  001a 7b03          	ld	a,(OFST+1,sp)
3064  001c 2626          	jrne	L1051
3065                     ; 1267     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection,
3065                     ; 1268                TIM2_ICFilter);
...
3075  002a 84            	pop	a
3076                     ; 1271     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
3078  002b 7b08          	ld	a,(OFST+6,sp)
3079  002d cd0000        	call	_TIM2_SetIC1Prescaler
3081                     ; 1274     TI2_Config((TIM2_ICPolarity_TypeDef)icpolarity, (TIM2_ICSelection_TypeDef)icselection, TIM2_ICFilter);
...
3091  003c 84            	pop	a
3092                     ; 1277     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
3094  003d 7b08          	ld	a,(OFST+6,sp)
3095  003f cd0000        	call	_TIM2_SetIC2Prescaler
3098  0042 2024          	jra	L3051
3099  0044               L1051:
3100                     ; 1282     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection,
3100                     ; 1283                TIM2_ICFilter);
...
3110  0050 84            	pop	a
3111                     ; 1286     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
3113  0051 7b08          	ld	a,(OFST+6,sp)
3114  0053 cd0000        	call	_TIM2_SetIC2Prescaler
3116                     ; 1289     TI1_Config((TIM2_ICPolarity_TypeDef)icpolarity, (TIM2_ICSelection_TypeDef)icselection, TIM2_ICFilter);
...
3126  0062 84            	pop	a
3127                     ; 1292     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
...
3137  006a 81            	ret	
3183                     ; 1301 uint16_t TIM2_GetCapture1(void)
3183                     ; 1302 {
...
3193                     ; 1306   tmpccr1h = TIM2->CCR1H;
3195  0002 c65261        	ld	a,21089
3196  0005 6b02          	ld	(OFST-2,sp),a
3198                     ; 1307   tmpccr1l = TIM2->CCR1L;
...
3224  001c 81            	ret	
3270                     ; 1320 uint16_t TIM2_GetCapture2(void)
3270                     ; 1321 {
...
3280                     ; 1325   tmpccr2h = TIM2->CCR2H;
3282  0002 c65263        	ld	a,21091
3283  0005 6b02          	ld	(OFST-2,sp),a
3285                     ; 1326   tmpccr2l = TIM2->CCR2L;
...
3311  001c 81            	ret	
3354                     ; 1344 void TIM2_SetIC1Prescaler(TIM2_ICPSC_TypeDef TIM2_IC1Prescaler)
3354                     ; 1345 {
...
3365                     ; 1349   assert_param(IS_TIM2_IC_PRESCALER(TIM2_IC1Prescaler));
3367                     ; 1351   tmpccmr1 = TIM2->CCMR1;
3369  0002 c65259        	ld	a,21081
3371                     ; 1354   tmpccmr1 &= (uint8_t)(~TIM_CCMR_ICxPSC);
3373  0005 a4f3          	and	a,#243
3375                     ; 1357   tmpccmr1 |= (uint8_t)TIM2_IC1Prescaler;
3377  0007 1a02          	or	a,(OFST+1,sp)
3379                     ; 1359   TIM2->CCMR1 = tmpccmr1;
3381  0009 c75259        	ld	21081,a
3382                     ; 1360 }
3385  000c 85            	popw	x
3386  000d 81            	ret	
3429                     ; 1372 void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
3429                     ; 1373 {
...
3440                     ; 1377   assert_param(IS_TIM2_IC_PRESCALER(TIM2_IC2Prescaler));
3442                     ; 1379   tmpccmr2 = TIM2->CCMR2;
3444  0002 c6525a        	ld	a,21082
3446                     ; 1382   tmpccmr2 &= (uint8_t)(~TIM_CCMR_ICxPSC);
3448  0005 a4f3          	and	a,#243
3450                     ; 1385   tmpccmr2 |= (uint8_t)TIM2_IC2Prescaler;
3452  0007 1a02          	or	a,(OFST+1,sp)
3454                     ; 1387   TIM2->CCMR2 = tmpccmr2;
3456  0009 c7525a        	ld	21082,a
3457                     ; 1388 }
3460  000c 85            	popw	x
3461  000d 81            	ret	
3547                     ; 1419 void TIM2_ITConfig(TIM2_IT_TypeDef TIM2_IT, FunctionalState NewState)
3547                     ; 1420 {
3548                     .text:	section	.text,new
3549  0000               _TIM2_ITConfig:
3551  0000 89            	pushw	x
3552       00000000      OFST:	set	0
3555                     ; 1422   assert_param(IS_TIM2_IT(TIM2_IT));
...
3564                     ; 1428     TIM2->IER |= (uint8_t)TIM2_IT;
3566  0005 9e            	ld	a,xh
3567  0006 ca5255        	or	a,21077
3569  0009 2006          	jra	L7461
3570  000b               L5461:
3571                     ; 1433     TIM2->IER &= (uint8_t)(~(uint8_t)TIM2_IT);
...
3581  0014 85            	popw	x
3582  0015 81            	ret	
3663                     ; 1448 void TIM2_GenerateEvent(TIM2_EventSource_TypeDef TIM2_EventSource)
3663                     ; 1449 {
3664                     .text:	section	.text,new
3665  0000               _TIM2_GenerateEvent:
3669                     ; 1451   assert_param(IS_TIM2_EVENT_SOURCE((uint8_t)TIM2_EventSource));
3671                     ; 1454   TIM2->EGR |= (uint8_t)TIM2_EventSource;
3673  0000 ca5258        	or	a,21080
3674  0003 c75258        	ld	21080,a
3675                     ; 1455 }
3678  0006 81            	ret	
3813                     ; 1470 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
3813                     ; 1471 {
...
3824                     ; 1473   uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
3828                     ; 1476   assert_param(IS_TIM2_GET_FLAG(TIM2_FLAG));
3830                     ; 1478   tim2_flag_l = (uint8_t)(TIM2->SR1 & (uint8_t)(TIM2_FLAG));
3832  0002 9f            	ld	a,xl
3833  0003 c45256        	and	a,21078
3834  0006 6b01          	ld	(OFST-1,sp),a
3836                     ; 1479   tim2_flag_h = (uint8_t)(TIM2->SR2 & (uint8_t)((uint16_t)TIM2_FLAG >> 8));
3838  0008 c65257        	ld	a,21079
3839  000b 1403          	and	a,(OFST+1,sp)
3840  000d 6b02          	ld	(OFST+0,sp),a
3842                     ; 1481   if ((uint8_t)(tim2_flag_l | tim2_flag_h) != 0)
...
3860  0017 81            	ret	
3895                     ; 1503 void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
3895                     ; 1504 {
3896                     .text:	section	.text,new
3897  0000               _TIM2_ClearFlag:
3899  0000 89            	pushw	x
3900       00000000      OFST:	set	0
3903                     ; 1506   assert_param(IS_TIM2_CLEAR_FLAG((uint16_t)TIM2_FLAG));
3905                     ; 1508   TIM2->SR1 = (uint8_t)(~(uint8_t)(TIM2_FLAG));
3907  0001 9f            	ld	a,xl
3908  0002 43            	cpl	a
3909  0003 c75256        	ld	21078,a
3910                     ; 1509   TIM2->SR2 = (uint8_t)(~(uint8_t)((uint16_t)TIM2_FLAG >> 8));
...
3918  000c 85            	popw	x
3919  000d 81            	ret	
3979                     ; 1523 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
3979                     ; 1524 {
...
3990                     ; 1527   uint8_t TIM2_itStatus = 0x0, TIM2_itEnable = 0x0;
3994                     ; 1530   assert_param(IS_TIM2_GET_IT(TIM2_IT));
3996                     ; 1532   TIM2_itStatus = (uint8_t)(TIM2->SR1 & (uint8_t)TIM2_IT);
3998  0002 c45256        	and	a,21078
3999  0005 6b01          	ld	(OFST-1,sp),a
4001                     ; 1534   TIM2_itEnable = (uint8_t)(TIM2->IER & (uint8_t)TIM2_IT);
4003  0007 c65255        	ld	a,21077
4004  000a 1403          	and	a,(OFST+1,sp)
4005  000c 6b02          	ld	(OFST+0,sp),a
4007                     ; 1536   if ((TIM2_itStatus != (uint8_t)RESET ) && (TIM2_itEnable != (uint8_t)RESET))
...
4031  001d 81            	ret	
4067                     ; 1558 void TIM2_ClearITPendingBit(TIM2_IT_TypeDef TIM2_IT)
4067                     ; 1559 {
4068                     .text:	section	.text,new
4069  0000               _TIM2_ClearITPendingBit:
4073                     ; 1561   assert_param(IS_TIM2_IT(TIM2_IT));
4075                     ; 1564   TIM2->SR1 = (uint8_t)(~(uint8_t)TIM2_IT);
4077  0000 43            	cpl	a
4078  0001 c75256        	ld	21078,a
4079                     ; 1565 }
4082  0004 81            	ret	
4155                     ; 1578 void TIM2_DMACmd( TIM2_DMASource_TypeDef TIM2_DMASource, FunctionalState NewState)
4155                     ; 1579 {
...
4189  0014 85            	popw	x
4190  0015 81            	ret	
4225                     ; 1602 void TIM2_SelectCCDMA(FunctionalState NewState)
4225                     ; 1603 {
...
4237                     ; 1610     TIM2->CR2 |= TIM_CR2_CCDS;
4239  0003 72165251      	bset	21073,#3
4242  0007 81            	ret	
4243  0008               L5312:
4244                     ; 1615     TIM2->CR2 &= (uint8_t)(~TIM_CR2_CCDS);
4246  0008 72175251      	bres	21073,#3
4247                     ; 1617 }
4250  000c 81            	ret	
4274                     ; 1641 void TIM2_InternalClockConfig(void)
4274                     ; 1642 {
4275                     .text:	section	.text,new
4276  0000               _TIM2_InternalClockConfig:
4280                     ; 1644   TIM2->SMCR &=  (uint8_t)(~TIM_SMCR_SMS);
4282  0000 c65252        	ld	a,21074
4283  0003 a4f8          	and	a,#248
4284  0005 c75252        	ld	21074,a
4285                     ; 1645 }
4288  0008 81            	ret	
4375                     ; 1662 void TIM2_TIxExternalClockConfig(TIM2_TIxExternalCLK1Source_TypeDef TIM2_TIxExternalCLKSource,
4375                     ; 1663                                  TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
...
4383                     ; 1667   assert_param(IS_TIM2_TIXCLK_SOURCE(TIM2_TIxExternalCLKSource));
4385                     ; 1668   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
4387                     ; 1669   assert_param(IS_TIM2_IC_FILTER(ICFilter));
4389                     ; 1672   if (TIM2_TIxExternalCLKSource == TIM2_TIxExternalCLK1Source_TI2)
4391  0001 9e            	ld	a,xh
4392  0002 a160          	cp	a,#96
4393  0004 260d          	jrne	L7022
4394                     ; 1674     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection_DirectTI, ICFilter);
...
4405  0013               L7022:
4406                     ; 1678     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection_DirectTI, ICFilter);
...
4415  001f               L1122:
4416  001f 84            	pop	a
4417                     ; 1682   TIM2_SelectInputTrigger((TIM2_TRGSelection_TypeDef)TIM2_TIxExternalCLKSource);
4419  0020 7b01          	ld	a,(OFST+1,sp)
4420  0022 cd0000        	call	_TIM2_SelectInputTrigger
4422                     ; 1685   TIM2->SMCR |= (uint8_t)(TIM2_SlaveMode_External1);
...
4430  002d 85            	popw	x
4431  002e 81            	ret	
4546                     ; 1704 void TIM2_ETRClockMode1Config(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
4546                     ; 1705                               TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
...
4554                     ; 1709   TIM2_ETRConfig(TIM2_ExtTRGPrescaler, TIM2_ExtTRGPolarity, ExtTRGFilter);
...
4586  002b 85            	popw	x
4587  002c 81            	ret	
4643                     ; 1736 void TIM2_ETRClockMode2Config(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
4643                     ; 1737                               TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
...
4651                     ; 1741   TIM2_ETRConfig(TIM2_ExtTRGPrescaler, TIM2_ExtTRGPolarity, ExtTRGFilter);
...
4660                     ; 1744   TIM2->ETR |= TIM_ETR_ECE ;
4662                     ; 1745 }
4665  000e 5b03          	addw	sp,#3
4666  0010 81            	ret	
4780                     ; 1796 void TIM2_SelectInputTrigger(TIM2_TRGSelection_TypeDef TIM2_InputTriggerSource)
4780                     ; 1797 {
...
4791                     ; 1801   assert_param(IS_TIM2_TRIGGER_SELECTION(TIM2_InputTriggerSource));
4793                     ; 1803   tmpsmcr = TIM2->SMCR;
4795  0002 c65252        	ld	a,21074
4797                     ; 1806   tmpsmcr &= (uint8_t)(~TIM_SMCR_TS);
4799  0005 a48f          	and	a,#143
4801                     ; 1807   tmpsmcr |= (uint8_t)TIM2_InputTriggerSource;
4803  0007 1a02          	or	a,(OFST+1,sp)
4805                     ; 1809   TIM2->SMCR = (uint8_t)tmpsmcr;
4807  0009 c75252        	ld	21074,a
4808                     ; 1810 }
4811  000c 85            	popw	x
4812  000d 81            	ret	
4909                     ; 1824 void TIM2_SelectOutputTrigger(TIM2_TRGOSource_TypeDef TIM2_TRGOSource)
4909                     ; 1825 {
...
4920                     ; 1829   assert_param(IS_TIM2_TRGO_SOURCE(TIM2_TRGOSource));
4922                     ; 1831   tmpcr2 = TIM2->CR2;
4924  0002 c65251        	ld	a,21073
4926                     ; 1834   tmpcr2 &= (uint8_t)(~TIM_CR2_MMS);
4928  0005 a48f          	and	a,#143
4930                     ; 1837   tmpcr2 |=  (uint8_t)TIM2_TRGOSource;
4932  0007 1a02          	or	a,(OFST+1,sp)
4934                     ; 1839   TIM2->CR2 = tmpcr2;
4936  0009 c75251        	ld	21073,a
4937                     ; 1840 }
4940  000c 85            	popw	x
4941  000d 81            	ret	
5022                     ; 1852 void TIM2_SelectSlaveMode(TIM2_SlaveMode_TypeDef TIM2_SlaveMode)
5022                     ; 1853 {
...
5033                     ; 1857   assert_param(IS_TIM2_SLAVE_MODE(TIM2_SlaveMode));
5035                     ; 1859   tmpsmcr = TIM2->SMCR;
5037  0002 c65252        	ld	a,21074
5039                     ; 1862   tmpsmcr &= (uint8_t)(~TIM_SMCR_SMS);
5041  0005 a4f8          	and	a,#248
5043                     ; 1865   tmpsmcr |= (uint8_t)TIM2_SlaveMode;
5045  0007 1a02          	or	a,(OFST+1,sp)
5047                     ; 1867   TIM2->SMCR = tmpsmcr;
5049  0009 c75252        	ld	21074,a
5050                     ; 1868 }
5053  000c 85            	popw	x
5054  000d 81            	ret	
5090                     ; 1876 void TIM2_SelectMasterSlaveMode(FunctionalState NewState)
5090                     ; 1877 {
...
5102                     ; 1884     TIM2->SMCR |= TIM_SMCR_MSM;
5104  0003 721e5252      	bset	21074,#7
5107  0007 81            	ret	
5108  0008               L5642:
5109                     ; 1888     TIM2->SMCR &= (uint8_t)(~TIM_SMCR_MSM);
5111  0008 721f5252      	bres	21074,#7
5112                     ; 1890 }
5115  000c 81            	ret	
5169                     ; 1908 void TIM2_ETRConfig(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
5169                     ; 1909                     TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
...
5177                     ; 1913   assert_param(IS_TIM2_EXT_PRESCALER(TIM2_ExtTRGPrescaler));
5179                     ; 1914   assert_param(IS_TIM2_EXT_POLARITY(TIM2_ExtTRGPolarity));
5181                     ; 1915   assert_param(IS_TIM2_EXT_FILTER(ExtTRGFilter));
5183                     ; 1918   TIM2->ETR |= (uint8_t)((uint8_t)((uint8_t)TIM2_ExtTRGPrescaler | (uint8_t)TIM2_ExtTRGPolarity)
...
5193  000c 85            	popw	x
5194  000d 81            	ret	
5301                     ; 1955 void TIM2_EncoderInterfaceConfig(TIM2_EncoderMode_TypeDef TIM2_EncoderMode,
5301                     ; 1956                                  TIM2_ICPolarity_TypeDef TIM2_IC1Polarity,
5301                     ; 1957                                  TIM2_ICPolarity_TypeDef TIM2_IC2Polarity)
5301                     ; 1958 {
...
5316                     ; 1964   assert_param(IS_TIM2_ENCODER_MODE(TIM2_EncoderMode));
5318                     ; 1965   assert_param(IS_TIM2_IC_POLARITY(TIM2_IC1Polarity));
5320                     ; 1966   assert_param(IS_TIM2_IC_POLARITY(TIM2_IC2Polarity));
5322                     ; 1968   tmpsmcr = TIM2->SMCR;
5324  0003 c65252        	ld	a,21074
5325  0006 6b01          	ld	(OFST-2,sp),a
5327                     ; 1969   tmpccmr1 = TIM2->CCMR1;
5329  0008 c65259        	ld	a,21081
5330  000b 6b02          	ld	(OFST-1,sp),a
5332                     ; 1970   tmpccmr2 = TIM2->CCMR2;
...
5343                     ; 1974   tmpsmcr |= (uint8_t)TIM2_EncoderMode;
...
5467                     ; 2020     TIM2->CR2 |= TIM_CR2_TI1S;
5469  0003 721e5251      	bset	21073,#7
5472  0007 81            	ret	
5473  0008               L1162:
5474                     ; 2024     TIM2->CR2 &= (uint8_t)(~TIM_CR2_TI1S);
5476  0008 721f5251      	bres	21073,#7
5477                     ; 2026 }
5480  000c 81            	ret	
5546                     ; 2047 static void TI1_Config(TIM2_ICPolarity_TypeDef TIM2_ICPolarity, \
5546                     ; 2048                        TIM2_ICSelection_TypeDef TIM2_ICSelection, \
5546                     ; 2049                        uint8_t TIM2_ICFilter)
5546                     ; 2050 {
...
5557                     ; 2052   uint8_t tmpicpolarity = TIM2_ICPolarity;
5559  0002 9e            	ld	a,xh
5560  0003 6b01          	ld	(OFST-1,sp),a
5562                     ; 2053   tmpccmr1 = TIM2->CCMR1;
5564  0005 c65259        	ld	a,21081
5565  0008 6b02          	ld	(OFST+0,sp),a
5567                     ; 2056   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
5569                     ; 2057   assert_param(IS_TIM2_IC_SELECTION(TIM2_ICSelection));
5571                     ; 2058   assert_param(IS_TIM2_IC_FILTER(TIM2_ICFilter));
5573                     ; 2061   TIM2->CCER1 &=  (uint8_t)(~TIM_CCER1_CC1E);
...
5581                     ; 2065   tmpccmr1 |= (uint8_t)(((uint8_t)(TIM2_ICSelection)) | ((uint8_t)(TIM2_ICFilter << 4)));
...
5592                     ; 2067   TIM2->CCMR1 = tmpccmr1;
5594  001f c75259        	ld	21081,a
5595                     ; 2070   if (tmpicpolarity == (uint8_t)(TIM2_ICPolarity_Falling))
5597  0022 7b01          	ld	a,(OFST-1,sp)
5598  0024 4a            	dec	a
5599  0025 2606          	jrne	L5462
5600                     ; 2072     TIM2->CCER1 |= TIM_CCER1_CC1P;
5602  0027 7212525b      	bset	21083,#1
5604  002b 2004          	jra	L7462
5605  002d               L5462:
5606                     ; 2076     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
5608  002d 7213525b      	bres	21083,#1
5609  0031               L7462:
5610                     ; 2080   TIM2->CCER1 |=  TIM_CCER1_CC1E;
5612  0031 7210525b      	bset	21083,#0
5613                     ; 2081 }
5616  0035 5b04          	addw	sp,#4
5617  0037 81            	ret	
5683                     ; 2098 static void TI2_Config(TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
5683                     ; 2099                        TIM2_ICSelection_TypeDef TIM2_ICSelection,
5683                     ; 2100                        uint8_t TIM2_ICFilter)
5683                     ; 2101 {
...
5694                     ; 2103   uint8_t tmpicpolarity = TIM2_ICPolarity;
5696  0002 9e            	ld	a,xh
5697  0003 6b01          	ld	(OFST-1,sp),a
5699                     ; 2106   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
5701                     ; 2107   assert_param(IS_TIM2_IC_SELECTION(TIM2_ICSelection));
5703                     ; 2108   assert_param(IS_TIM2_IC_FILTER(TIM2_ICFilter));
5705                     ; 2110   tmpccmr2 = TIM2->CCMR2;
5707  0005 c6525a        	ld	a,21082
5708  0008 6b02          	ld	(OFST+0,sp),a
5710                     ; 2113   TIM2->CCER1 &=  (uint8_t)(~TIM_CCER1_CC2E);
...
5718                     ; 2117   tmpccmr2 |= (uint8_t)(((uint8_t)(TIM2_ICSelection)) | ((uint8_t)(TIM2_ICFilter << 4)));
...
5729                     ; 2119   TIM2->CCMR2 = tmpccmr2;
5731  001f c7525a        	ld	21082,a
5732                     ; 2122   if (tmpicpolarity == TIM2_ICPolarity_Falling)
5734  0022 7b01          	ld	a,(OFST-1,sp)
5735  0024 4a            	dec	a
5736  0025 2606          	jrne	L1072
5737                     ; 2124     TIM2->CCER1 |= TIM_CCER1_CC2P ;
5739  0027 721a525b      	bset	21083,#5
5741  002b 2004          	jra	L3072
5742  002d               L1072:
5743                     ; 2128     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
5745  002d 721b525b      	bres	21083,#5
5746  0031               L3072:
5747                     ; 2132   TIM2->CCER1 |=  TIM_CCER1_CC2E;
