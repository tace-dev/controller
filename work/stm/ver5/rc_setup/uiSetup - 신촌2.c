...
*/
	...
	uiInfo.lpmType_sub = 0;
	uiInfo.subRCLock = 0;
	__cntlMode = uiInfo.cntlMode = 1;	//	0 local, 1 each
	/*
		2015.9.22
	 */
	/*
...
uiInfo.houseCapa = 200;		//100 default for each mode;
	...
	case 1:
		uiInfo.cnt = 2;
		uiInfo.valve = 2;
		uiInfo.valve_len[0] = 40;
		uiInfo.valve_len[1] = 50;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 2;
		break;
	case 2:
	...
	case 4:
		uiInfo.cnt = 3;
		uiInfo.valve = 3;
		uiInfo.valve_len[0] = 60;
		uiInfo.valve_len[1] = 70;
		uiInfo.valve_len[2] = 50;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 2;
		uiInfo.valve_rc[2] = 3;
		break;
	...
	case 6:
		uiInfo.cnt = 4;
		uiInfo.valve = 5;
		uiInfo.valve_len[0] = 100;
		uiInfo.valve_len[1] = 85;
		uiInfo.valve_len[2] = 90;
		uiInfo.valve_len[3] = 85;
		uiInfo.valve_len[4] = 70;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 2;
		uiInfo.valve_rc[2] = 3;
		uiInfo.valve_rc[3] = 4;
	...
	case 7:
		...
		uiInfo.valve_len[0] = 60;
		uiInfo.valve_len[1] = 70;
		uiInfo.valve_len[2] = 55;
		uiInfo.valve_len[3] = 60;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 2;
		uiInfo.valve_rc[2] = 3;
		uiInfo.valve_rc[3] = 4;
	...
	case 8:
		...
		uiInfo.valve = 5;
		uiInfo.valve_len[0] = 90;
		uiInfo.valve_len[1] = 75;
		uiInfo.valve_len[2] = 60;
		uiInfo.valve_len[3] = 60;
	...
	case 9:
		...
		uiInfo.valve = 7;
		uiInfo.valve_len[0] = 90;
		uiInfo.valve_len[1] = 60;
		uiInfo.valve_len[2] = 90;
		uiInfo.valve_len[3] = 80;
		uiInfo.valve_len[4] = 70;
		uiInfo.valve_len[5] = 90;
		uiInfo.valve_len[6] = 65;
		uiInfo.valve_rc[0] = 1;
		uiInfo.valve_rc[1] = 1;
		uiInfo.valve_rc[2] = 2;
		uiInfo.valve_rc[3] = 3;
